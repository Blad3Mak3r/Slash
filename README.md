...
[jda]: https://github.com/DV8FromTheWorld/JDA/releases/tag/v6.0.0-rc.4
...
Slash is a library written 100% with **[Kotlin][kotlin]** that works with **[JDA 6.0.0-rc.4 (Java Discord API)][jda]** for an advanced implementation of **[Application Commands][slash-commands]** for Discord.
